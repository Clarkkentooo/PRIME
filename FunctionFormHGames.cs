...
namespace PRIME3
{
    public partial class FunctionFormHGames : Form
    {
        ...
        public static FunctionFormHGames instance2;
        public System.Windows.Forms.Panel paneldesk;
        public FunctionFormHGames()
        {
            InitializeComponent();
            instance2 = this;
        ...
        private void add2CartText1_Click(object sender, EventArgs e)
        {
            ...
            {
                Home.instance.addtoCartImage.Image = Properties.Resources.cartHG;
