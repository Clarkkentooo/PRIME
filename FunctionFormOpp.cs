...
namespace PRIME3
{
    public partial class FunctionFormOpp : Form
    {
        ...
        public static FunctionFormOpp instance2;
        public System.Windows.Forms.Panel paneldesk;
        public FunctionFormOpp()
        {
            InitializeComponent();
            instance2 = this;
        ...
        private void UpdateLabels()
        {
            ...
            // Total Amount
            totalAmount.Text = (clickedButtonTexts.Count * 680).ToString();
            totAmountReceipt.Text = (clickedButtonTexts.Count * 680).ToString();
        }
        ...
        private void add2CartText1_Click(object sender, EventArgs e)
        {
            ...
            {
                Home.instance.addtoCartImage.Image = Properties.Resources.cartOppen;
