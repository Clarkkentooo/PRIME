...
namespace PRIME3
{
    public partial class FunctionFormKfPanda : Form
    {
        ...
        public static FunctionFormKfPanda instance2;
        public System.Windows.Forms.Panel paneldesk;
        public FunctionFormKfPanda()
        {
                InitializeComponent();
                instance2 = this;
            ...
            private void add2CartText1_Click(object sender, EventArgs e)
            {
                ...
                {
                    Home.instance.addtoCartImage.Image = Properties.Resources.cartKfPanda;
