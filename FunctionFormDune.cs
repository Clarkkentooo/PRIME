...
namespace PRIME3
{
    public partial class FunctionFormDune : Form
    {
        ...
        public static FunctionFormDune instance1;
        public System.Windows.Forms.Panel paneldesk;
        public FunctionFormDune()
        {
            InitializeComponent();
            instance1 = this;
        ...
        private void UpdateLabels()
        {
            ...
            // Total Amount
            totalAmount.Text = (clickedButtonTexts.Count * 480).ToString();
            totAmountReceipt.Text = (clickedButtonTexts.Count * 480).ToString();
        }
        ...
        private void add2CartText1_Click(object sender, EventArgs e)
        {
            ...
            {
                Home.instance.addtoCartImage.Image = Properties.Resources.cartDune;
